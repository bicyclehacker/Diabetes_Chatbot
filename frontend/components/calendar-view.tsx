...
export function CalendarView() {
        ...
        const fetchReminders = async () => {
            try {
                ...
                const mapped: CalendarEvent[] = data.map((r: any) => ({
                    ...
                    type: r.type
                        .toLowerCase()
                        .replace(' ', '') as CalendarEvent['type'], // normalize
                    isTask: r.isTask,
                    completed: r.completed,
                    frequency:
                        r.frequency.toLowerCase() as CalendarEvent['frequency'],
    ...
    const addEvent = async () => {
        ...
        try {
            ...
            const event: CalendarEvent = {
                ...
                type: saved.type
                    .toLowerCase()
                    .replace(' ', '') as CalendarEvent['type'],
                isTask: saved.isTask,
                completed: saved.completed,
                frequency:
                    saved.frequency.toLowerCase() as CalendarEvent['frequency'],
    ...
    const todaysTasks = events.filter(
        (event) => isToday(event.date) && event.isTask
    );
    const completedTasks = todaysTasks.filter((task) => task.completed);
    const activeReminders = events.filter(
                ...
                <Card className="lg:col-span-2 border-0 shadow-lg">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Click on any date to view and manage your health
                                events
                            </CardDescription>
                        </div>
                        <Dialog
                        ...
                        >
                            ...
                            <DialogContent className="max-w-md">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Create a new health event, task, or
                                        reminder
                                    </DialogDescription>
                                </DialogHeader>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <Checkbox
                                                ...
                                                onCheckedChange={(checked) =>
                                                    setNewEvent({
                                                        ...newEvent,
                                                        isTask: checked as boolean,
                                                    })
                                                }
                                            />
                                            <Label htmlFor="isTask">
                                                Make it a task
                                            </Label>
                                        </div>
                                        <div className="flex items-center space-x-2">
                ...
                >
                    <DialogContent className="max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Update your health event details
                            </DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4">
                            <div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    />
                                    <Label htmlFor="edit-emailReminder">
                                        Email reminder
                                    </Label>
                                </div>
                            </div>
